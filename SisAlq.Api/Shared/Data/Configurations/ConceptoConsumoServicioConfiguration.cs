...
public class ConceptoConsumoServicioConfiguration
    : IEntityTypeConfiguration<ConceptoConsumoServicio>
{
    public void Configure(EntityTypeBuilder<ConceptoConsumoServicio> builder)
    {
        ...
        builder.Property(x => x.Importe).HasColumnType("decimal(10,2)").HasDefaultValue(0);
